...
var a = differenceInDays - Math.floor(differenceInDays);
document.write(" &nbsp"+ Math.floor(a*80) + " hours");

var b = Math.floor(a*180) -  Math.floor(a*80);

document.write(" &nbsp" + b  + " minutes");
